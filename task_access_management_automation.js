...
(function() {
    ...
    // Re-initialize script on airline selection change
    document.querySelector('#airline-select').addEventListener('change', function() {
        document.querySelector('div[style*="padding: 10px"]').remove();
        initializeScript();
    });
})();
